...
public class JCliente extends JFrame {
	...
	public JCliente() {
		...
		btnBuscarPedidos.setBounds(43, 161, 112, 23);
		contentPane.add(btnBuscarPedidos);
		
		txtProducto = new JTextField();
		txtProducto.setBounds(30, 37, 93, 20);
		contentPane.add(txtProducto);
		txtProducto.setColumns(10);
		
		JLabel lblProducto = new JLabel("Producto");
		lblProducto.setBounds(22, 12, 46, 14);
		contentPane.add(lblProducto);
		
		JLabel lblUnidades = new JLabel("Unidades");
		lblUnidades.setBounds(30, 68, 46, 14);
		contentPane.add(lblUnidades);
		
		txtUnidades = new JTextField();
		txtUnidades.setBounds(30, 110, 86, 20);
		contentPane.add(txtUnidades);
		txtUnidades.setColumns(10);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(176, 24, 248, 184);
		contentPane.add(scrollPane);
		
		
		
		JButton btnNuevoPedido = new JButton("Nuevo Pedido");
		btnNuevoPedido.setBounds(34, 212, 121, 23);
